...
namespace graphene { namespace chain {
     ...
     typedef multi_index_container<
        pocs_object, indexed_by<
          ...
          ordered_non_unique<tag<by_alliance_id>, composite_key<pocs_object, member<pocs_object, alliance_id_type, &pocs_object::alliance_id>>>,
          ordered_non_unique<tag<by_account_id>, composite_key<pocs_object, member<pocs_object, account_id_type, &pocs_object::account_id>>>,
          ordered_unique<tag<by_multi_id>, composite_key<pocs_object, member<pocs_object, alliance_id_type, &pocs_object::alliance_id>,
 ...
 FC_REFLECT_DERIVED (graphene::chain::pocs_object,
                     ...
                     (alliance_id)(account_id)(total_sell)(total_buy))
